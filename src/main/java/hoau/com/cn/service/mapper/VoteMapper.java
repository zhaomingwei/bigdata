 ...
 * @Time: 16:42
 */
public class VoteMapper extends Mapper<LongWritable, Vote, Text, Vote> {
     ...
     */
    @Override
    protected void map(LongWritable key, Vote value, Context context) throws IOException, InterruptedException {
