...
/**
 * @Description: 效率监控看板-发货看板数据mapper处理
 * @Author: zhaowei
 * @Date: 2020/10/19
 * @Time: 16:42
 */
public class LxFhMapper extends Mapper<LongWritable, Text, Text, Text> {
...
//            System.out.println("LxFhMapper->:key:" + key + ", value:" + val);
            context.write(k, value);
        } catch (Exception e) {
            System.out.println("LxFhMapper-exception:" + e);
        }
    }
