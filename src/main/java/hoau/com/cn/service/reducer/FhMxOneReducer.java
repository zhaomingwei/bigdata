...
//                            System.out.println("FhMxOneReducer->:key:" + key + ", value:" + f1.toString());
                ...
                if (StringUtils.equals("1", tag) && !tmp1.isEmpty()) {
                    for (FhMxAndDhMxOut f : tmp1) {
                        ...
                        f.setRCVMSGDATE("");
                        f.setSCANDATE("");
//                        System.out.println("FhMxOneReducer->:key:" + key + ", value:" + f.toString());
                        context.write(key, new Text(f.toString()));
                    }
                }
            }
        } catch (Exception e) {
            System.out.println("FhMxOneReducer->exception:" + e);
        }
    }
